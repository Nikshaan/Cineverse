...
const Modal = ({closeModal, MovieId}) => {
    ...
    return (
        <div className="w-screen h-[100svh] bg-white bg-opacity-75 dark:bg-black dark:bg-opacity-75 fixed top-0 bottom-0 right-0 left-0 flex justify-center items-center">
            ...
            {
            movie.Title == "none" 
            ? <div className="flex justify-center items-center text-3xl font-raleway">
                <p>Loading</p>
                <img alt="loader" src={loader} className="w-24"/>
              </div>
            : <div className="flex flex-col mt-6 2xl:mt-10 p-2 justify-start h-full items-center">
                <div className="w-full flex flex-col gap-4 lg:gap-10 text-center p-2 items-center justify-center">
                    ...
                    <img alt="poster" src={movie.Poster} className="w-40 md:w-48 lg:w-56 2xl:w-72 border-2 border-white dark:border-black"/>
