...
const MovieCard = ({id, poster, title, year}) => {
  ...
  return (
    <div className="flex flex-col flex-nowrap text-white min-w-44 max-w-48 lg:min-w-56 2xl:min-w-72 p-1 justify-start items-center dark:text-black dark:bg-blue-400 bg-blue-800 text-red">
        <img alt="movieImage" src={imgSrc} onError = {() => setImgSrc(defaultMovie)} className="w-full h-full mb-2"/>
