  ...
  return (
    <div className="h-full w-full bg-black pb-4">
        ...
        <div className="p-1 text-white -mt-5 mb-4 w-full font-raleway z-10 flex flex-col justify-center items-center">
          ...
          <button className="my-1 sm:my-2 lg:text-xl bg-white bg-opacity-0 hover:bg-opacity-100 hover:text-black duration-300 border-2 p-1 px-3 rounded-2xl">Learn more</button>
        </div>
        <p className="text-white text-3xl 2xl:text-5xl pl-2 font-raleway -mb-1">Suggested Movies</p>
        <Batman/>
        <HarryPotter/>
        <StarWars/>
        <WimpyKid/>
